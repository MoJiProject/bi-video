<template>
    <div class="video">
        <a class="video-link" :href="'./video?videoId=BV'+video.videoId" target="videoWindow" @mouseover="videoMouseover(sign+video.videoId)" @mouseleave="videoMouseleave(sign+video.videoId)">
         <img class="cover-img" :src="video.coverAddress">
         <video class="video-content" :src="video.videoAddress"
           :id="sign+video.videoId"
           preload="none"
