  ...
  <div class="comment-container"  v-loading.fullscreen="loading" element-loading-background="rgba(122, 122, 122, 0)">
    <div class="comment-header">
      <div class="comment-title">
        评论
        <span class="comment-number">{{ props.dynamic.video.videoCommentNumber }}</span>
        <span
    ...
    <a v-else :href="'./video?videoId=BV'+props.dynamic.dynamic.videoId" target="videoWindow" class="comment-footer-info2">查看更多评论</a>
  ...
  setup(props) {
    ...
    async function publishComment() {
      ...
      for (const link of links) {
        ...
        if(userId&&index===-1&&userId!==store.userId)
        {
          let at={
            userId: store.userId,
            atUserId: userId,
            videoId: props.dynamic.dynamic.videoId,
         }
        atUserList.push(at);
        }
      ...
      if (res.data.code === 1) {
        ...
        props.dynamic.video.videoCommentNumber++;
    ...
    async function deleteCommentAxios() {
      ...
      if (res.data.code === 1) {
        ...
        if(mainCommentId.value===null)
        {
          ...
          if(index!==-1)
            props.dynamic.video.videoCommentNumber=props.dynamic.video.videoCommentNumber-commentList[index].replyNumber-1;
