  ...
  <div class="comment-container"  v-loading.fullscreen="loading" element-loading-background="rgba(122, 122, 122, 0)">
    <div class="comment-header">
      <div class="comment-title">
        评论
        <span class="comment-number">{{ props.dynamic.dynamic.commentNumber }}</span>
        <span
    ...
    <div
      ...
      >
        ...
        <div
            ...
            :class="{ replyCommentClass: comment.replyFlag,replyCommentClass2: remark.comments.imgAddress.split(',').length>1&&comment.replyFlag}"
    ...
    <div v-if="commentTotal<=10" class="comment-footer-info">没有更多评论</div>
    <a v-else :href="'./video?videoId=BV'+props.dynamic.dynamic.id" target="videoWindow" class="comment-footer-info2">查看更多评论</a>
...
import {putUpStatus} from "@/api/comment/index"
export default {
  name: "Comment",
  components: {
    eit,
